...
# 2. Читаем parquet
# =====================
cols = ["longitude", "latitude", "market_type", "price_per_square_meter"]

df = pq.read_table("data/processed/housing.parquet", columns=cols).to_pandas()
...
draw_heatmap(
    ...
    "data/plots/heatmap_primary.png",
    cmap="Reds",
)
...
draw_heatmap(
    ...
    "data/plots/heatmap_secondary.png",
    cmap="Blues",
)
